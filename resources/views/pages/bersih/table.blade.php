                            ...
                            <tbody>
                                @forelse($data as $table)
                                    <tr>
										...
										<td>{{ $table->bersih_key }}</td>
										<td>{{ $table->bersih_rfid }}</td>
										<td>{{ $jenis[$table->bersih_id_jenis]->jenis_nama ?? '' }}</td>
                                        <td>{{ $ruangan[$table->bersih_id_ruangan]->ruangan_nama ?? '' }}</td>
										<td>{{ formatDate($table->bersih_datetime, true) }}</td>
